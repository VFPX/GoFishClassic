...
The file used by GoFish to render the colors in the code is: GoFishCustom.css
...
Choose which one you want to use, and *COPY* it to a file named "GoFishCustom.css" in this
same directory. You may then modify the new GoFishCustom.css to color you code to your own preferences.


Again, neither of these 2 templates are actually used by GoFish. Only a file name GoFishCustom.css is used
at run time.

GoFishCustom.css  <-- This is the css file name that will be used by GoFish
